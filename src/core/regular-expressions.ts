 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getCodeBlockRE(multiline = false): RegExp {
  if (!multiline) {
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getIDRE(idGenPattern: string, exact = false): RegExp {
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getInlineMathRE(global = false): RegExp {
  const flag = global ? 'g' : '';
  return RegExp(
 ...
 * @return  {RegExp}              The compiled Regular Expression
 */
export function getInlineMathRenderRE(global = false): RegExp {
  const flag = global ? 'g' : '';
  return RegExp(
 ...
 * @return  {RegExp}           The compiled Regular Expression
 */
export function getLinkRE(global = false): RegExp {
 ...
 * @return  {RegExp}           The compiled Regular Expression
 */
export function getUrlRE(global = false): RegExp {
  return RegExp(
 ...
 * @return  {RegExp}                   The compiled Regular Expression
 */
export function getZknTagRE(global = false): RegExp {
  return RegExp(
    /(?<=^|\s|[({[])#(#?[^\s,.:;…!?"'`»«“”‘’—–@$%&*#^+~÷\\/|<=>[\](){}]+#?)/
      .source,
    global ? 'gi' : 'i'
